...
const generatedExtendedRoutes: ExtendedRouteConfig[] = [
  ...
  { path: 'admin/voting/:id/results', componentPath: '../app/admin/voting/MonitorLiveResultPage.jsx' },
  { path: 'admin/voting/:id/candidates', componentPath: '../app/admin/voting/ManageCandidatesPage.jsx' },
  { path: 'admin/voting/:votingId/candidates/:candidateId', componentPath: '../app/admin/voting/CandidateDetailsPage.jsx' },
  { path: 'admin/voting/:id/edit', componentPath: '../app/admin/voting/EditElectionPage.jsx' },
  { path: 'admin/voting/:new-election', componentPath: '../app/admin/voting/New-Election.jsx' },
  { path: 'applications', componentPath: '../app/applications/page.jsx' },
  { path: 'benefits', componentPath: '../app/benefits/page.jsx' },
  { path: 'admin/benefits/:id/applicants', componentPath: '../app/benefits/[id]/applicants/page.jsx' },
  ...
  { path: 'settings', componentPath: '../app/settings/page.jsx' },
  ...
  { path: 'super-admin/audit-reports', componentPath: '../app/super-admin/audit-reports/page.jsx' },
  ...
  { path: '*', componentPath: '../app/__create/not-found.tsx' },
];
