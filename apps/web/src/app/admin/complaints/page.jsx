                  ...
                  <tr key={complaint.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <div className="text-sm font-medium text-gray-900 dark:text-white">{complaint.citizenName}</div>
                    ...
                    <td className="px-6 py-4">
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400 truncate w-64">{complaint.description}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
