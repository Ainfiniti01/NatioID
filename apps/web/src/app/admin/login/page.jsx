    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          {/* Intro and Download Button */}
          <div className="mt-4 text-center">
            <p className="text-sm text-gray-300">
              This is a demo of a national digital ID & voting system.
            </p>
            <p className="text-xs text-gray-400 mt-1">
              Contact:{" "}
              <a
                href="mailto:abdulazeezadam09@gmail.com"
                className="text-[#ECBE07] hover:underline"
              >
            ...
            <div className="mt-4">
              <a
                href="https://expo.dev/accounts/ainfiniti/projects/natioid/builds/f66d46db-007c-4da7-9cda-db6db180115e"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-green-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-green-700 transition-colors duration-300"
              >
                Try Citizen App (Download APK)
              </a>
            </div>
          </div>
        </div>
