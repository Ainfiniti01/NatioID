...
export default function SuperAdminLoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    // Simulate API call
    setTimeout(() => {
      if (formData.email === 'superadmin@natioid.gov.ng' && formData.password === 'SuperAdmin123!') {
        // Check for IP restriction (dummy)
        const userIP = '192.168.1.100'; // Simulated IP
        const allowedIPs = ['192.168.1.100', '10.0.0.0'];
        
        if (!allowedIPs.includes(userIP)) {
          setIpRestrictionWarning(true);
          setIsLoading(false);
          return;
        }
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="superadmin@natioid.gov.ng"
                    required
                  />
                </div>
              </div>
